...
def queue_request():
    ...
    output_manager.update_song_status(new_song.id, 'separating')
    ...
    try:
        ...
        with open(save_path, 'rb') as f:
            files={'music_file': (filename, f, file.mimetype)}
    ...
    # Return response (using updated data if available, or errors if not)
    return jsonify({
        'song_id': song_id,
